...
void RgpuAco( int *pt_nNodes, float *distMat_h, int *bestTour_h, float *pt_bestGraphLength, float *pt_rho, float *pt_alpha, float *pt_beta, float *pt_Q, int *pt_nAnts, int *pt_maxIterations, int *pt_convergenceNo, int *pt_nThreads, float *pt_elapsedTime, int *pt_iterNo ){
	gpuAco( pt_nNodes, distMat_h, bestTour_h, pt_bestGraphLength, pt_rho, pt_alpha, pt_beta, pt_Q, pt_nAnts, pt_maxIterations, pt_convergenceNo, pt_nThreads, pt_elapsedTime, pt_iterNo );
}

void RrpcGpuAco( char **pt_server, int *pt_nNodes, float *distMat_h, int *bestTour_h, float *pt_bestGraphLength, float *pt_rho, float *pt_alpha, float *pt_beta, float *pt_Q, int *pt_nAnts, int *pt_maxIterations, int *pt_convergenceNo, int *pt_nThreads, int *pt_iterNo){
	rpcGpuAco( pt_server, pt_nNodes, distMat_h, bestTour_h, pt_bestGraphLength, pt_rho, pt_alpha, pt_beta, pt_Q, pt_nAnts, pt_maxIterations, pt_convergenceNo, pt_nThreads, pt_iterNo ); 
}
