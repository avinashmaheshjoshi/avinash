...
#=====================================================================
# Ensure that the "tests" folder and the mint proto code file can be 
...
test.suite <- defineTestSuite("mintFunctionUnits",
                              dirs = file.path("tests"),
                              testFileRegexp = 'testLR.R')

test.result <- runTestSuite(test.suite)

printTextProtocol(test.result, fileName ="Test_Log_And_Returns_Results.txt")